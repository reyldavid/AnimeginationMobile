...
var AddressSettingsComponent = (function () {
    ...
    AddressSettingsComponent.prototype.Update = function () {
        ...
        this.isSuccess = null;
        this.isFailure = null;
        console.log('aya Update Address Settings');
        this._customerService.updateUserAccount(this.token, this.addressInput)
            .then(function (userAccount) {
            _this.addressInput.Address = userAccount.address;
...
//# sourceMappingURL=addressSettings.js.map