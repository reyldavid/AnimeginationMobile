...
var ProductService = (function () {
    ...
    ProductService.prototype.getApiProduct = function (productId) {
        ...
        return new Promise(function (resolve) {
            _this._apiService.getAnimeProduct(productId)
                .subscribe(function (data) { return resolve(data); }, function (error) { return alert(error); }, function () { return console.log("Api Product seikoo"); });
        });
    };
    ...
    ProductService.prototype.getApiSimilars = function (productID) {
        var _this = this;
        return new Promise(function (resolve) {
            _this._apiService.getSimilarsListing(productID)
                .subscribe(function (data) { return resolve(data); }, function (error) { return alert(error); }, function () { return console.log("Api Similars seikoo"); });
        });
    };
    ProductService.prototype.getSearchResults = function (searchText) {
        var _this = this;
        return new Promise(function (resolve) {
            _this._apiService.getSearchResults(searchText)
                .subscribe(function (data) { return resolve(data); }, function (error) { return alert(error); }, function () { return console.log("Api Search seikoo"); });
        });
    };
    ProductService.prototype.getCategories = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this._apiService.getCategories()
                .subscribe(function (data) { return resolve(data); }, function (error) { return alert(error); }, function () { return console.log("Api Categories seikoo"); });
        });
    };
    ProductService.prototype.getCategoryList = function (categoryID) {
        var _this = this;
        return new Promise(function (resolve) {
            _this._apiService.getCategoryList(categoryID)
                .subscribe(function (data) { return resolve(data); }, function (error) { return alert(error); }, function () { return console.log("Api Category List seikoo"); });
        });
    };
    ProductService.prototype.getCategory = function (categoryID) {
        var _this = this;
        return new Promise(function (resolve) {
            _this._apiService.getCategory(categoryID)
                .subscribe(function (data) { return resolve(data); }, function (error) { return alert(error); }, function () { return console.log("Api Category seikoo"); });
        });
    };
